...
public class Programa {
    public static void main(String[] args) {
        ...
        var funcionario = new Funcionario("José Pereira", Funcionario.Funcao.Limpeza);
        cozinhaMineira.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Dario Silva", Funcionario.Funcao.Cozinheiro);
        cozinhaMineira.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Mauro César", Funcionario.Funcao.Ajudante);
        cozinhaMineira.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Jonas Brasil", Funcionario.Funcao.Outro);
        cozinhaMineira.adicionarFuncionario(funcionario);
        ...
        ingrediente = new Ingrediente("Shoyu", LocalDate.of(2020, 4, 10));
        ...
        funcionario = new Funcionario("Ana Moura", Funcionario.Funcao.Cozinheiro);
        cozinhaChinesa.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("José Andrade", Funcionario.Funcao.Cozinheiro);
        cozinhaChinesa.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Alberto Silveira", Funcionario.Funcao.Ajudante);
        cozinhaChinesa.adicionarFuncionario(funcionario);
        ...
        ingrediente = new Ingrediente("Molho de Tomate", LocalDate.of(2020, 4, 21));
        ...
        funcionario = new Funcionario("Nayara Farinha", Funcionario.Funcao.Cozinheiro);
        cozinhaItaliana.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Gilmar Filho", Funcionario.Funcao.Outro);
        cozinhaItaliana.adicionarFuncionario(funcionario);
        funcionario = new Funcionario("Marcelo Moreira", Funcionario.Funcao.Ajudante);
        cozinhaItaliana.adicionarFuncionario(funcionario);
